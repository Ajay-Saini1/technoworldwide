...
class BrandExportView(View):
    def get(self, request, *args, **kwargs):
        ...
        for row_num, brand in enumerate(brands, start=1):
            row_data = [brand.name, brand.description]
